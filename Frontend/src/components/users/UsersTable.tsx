...
const UsersTable: React.FC<Props> = ({ data, onEdit, onDelete, onDetail }) => {
        ...
        <tbody>
          {data.length === 0 ? (
            <tr className="user-table__tr">
              <td colSpan={11} className="user-table__empty">
                Ma'lumot topilmadi
              </td>
            </tr>
          ) : (
            data.map((row, index) => (
              ...
              >
                ...
                <td className="user-table__td">{row.role}</td>
                ...
                <td className="user-table__td">{formatDate(row.updated_at)}</td>
                <td className="user-table__td user-table__td--actions">
                  <div className="user-table__actions">
                    ...
                    <button
                      className="user-table__btn user-table__btn--detail p-2"
