...
const migrate = async () => {
  ...
  `);
    ...
    logger_1.logger.info('Backfill: mavjud ma\'lumotlar hisoblanmoqda...');
    await database_1.db.query(`
    DO $$
    DECLARE
      v_rec RECORD;
    ...
    $$;
  `);
    logger_1.logger.info('Daily scores migration completed');
    process.exit(0);
};
migrate().catch(err => {
...
//# sourceMappingURL=migrate_daily.js.map