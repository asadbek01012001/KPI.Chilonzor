...
const FONT_SIZE = 14;
function cell(ws, row, col, value, bgColor = WHITE, bold = false, align = 'center') {
...
async function generateReportExcel(tableData, directions) {
    ...
    tableData.forEach((row, idx) => {
        ...
        for (const dir of directions) {
            const found = row.directions?.find((d) => d.direction_id === dir.id);
